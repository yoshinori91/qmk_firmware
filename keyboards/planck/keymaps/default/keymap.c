...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    LGUI(KC_SPC), KC_A,  KC_S,  KC_D,          KC_F,               KC_G,  KC_H,           KC_J,              KC_K,          KC_L,    OSM(MOD_LGUI), KC_ENT,
...
[_LOWER] = LAYOUT_planck_grid(
    KC_NO,   KC_NO, KC_AMPR, KC_ASTR, KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_7, KC_8,  KC_9,  KC_NO,
    KC_NO,   KC_NO, KC_DLR,  KC_PERC, KC_CIRC, KC_NO,   KC_NO,   KC_NO, KC_4, KC_5,  KC_6,  KC_NO,
    KC_NO,   KC_NO, KC_EXLM, KC_AT,   KC_HASH, KC_NO,   KC_NO,   KC_NO, KC_1, KC_2,  KC_3,  KC_NO,
    QK_BOOT, KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_BSPC, KC_BSPC, KC_NO, KC_0, KC_NO, KC_NO, KC_NO 
),
[_RAISE] = LAYOUT_planck_grid(
    KC_F1, KC_F2,    KC_F3,   KC_F4,   KC_F5,   KC_F6, KC_F7,   KC_F8,   KC_F9, KC_F10,  KC_F11, KC_F12,
    KC_NO, TD(TD_R), KC_LCBR, KC_RCBR, KC_LPRN, KC_RPRN, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO,  KC_NO,
